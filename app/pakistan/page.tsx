...
export const metadata: Metadata = {
  ...
  description:
    "Convert tola to grams in Pakistan and calculate gold value in PKR. Instant tola weight conversion and gold price calculator for Pakistani gold market.",
  keywords:
    "tola to grams pakistan, gold tola pakistan, gold rate pakistan pkr, tola converter",
  alternates: {
        ...
        <div className="container-max">
          <div className="glass-card p-6 rounded-2xl md:p-8">
            <h2 className="text-2xl font-bold gradient-text mb-6">
              About Tola in Pakistan
            </h2>
            <div className="space-y-5 text-slate-300 leading-relaxed">
              <p>
                The tola is the primary unit in Pakistan's gold market. Whether
                buying jewelry in Karachi or trading in Islamabad, this
                converter helps with accurate tola to grams conversion.
              </p>
              <p>
