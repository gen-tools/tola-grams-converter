        ...
        <div className="container-max">
          <div className="glass-card p-6 rounded-2xl md:p-8">
            ...
            <div className="space-y-5 text-slate-300 leading-relaxed">
              <p>
                The UK primarily uses grams and troy ounces for gold trading.
                However, for jewelers and traders working with South Asian
                suppliers and communities, understanding tola conversion is
