        ...
        <div className="container-max">
          <div className="glass-card p-6 rounded-2xl md:p-8">
            ...
            <div className="space-y-5 text-slate-300 leading-relaxed">
              <p>
                Dubai is a major hub for gold trading and jewelry manufacturing.
                While UAE officially uses the metric system, tola is widely
                recognized in traditional gold trading, especially among South
                Asian traders and communities.
              </p>
              <p>
