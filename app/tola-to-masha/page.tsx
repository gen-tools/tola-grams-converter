            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 glass-card p-6 rounded-2xl md:p-8">
                <div className="mb-8">
                  ...
                  <p className="text-sm text-slate-400">
                    Convert tola to masha and vice versa
                  </p>
                </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="glass-card p-6 rounded-2xl glow-gold border border-amber-500/20">
                  ...
                  {hasResult ? (
                    <>
                      <p className="text-white font-bold md:text-5xl text-4xl leading-tight">
                        {input2}
                      </p>
                      <p className="text-slate-300 text-sm mt-3 font-medium">
                        {input1} Tola = {input2} Masha
                      </p>
                    </>
                  ) : (
                    <div className="flex items-center justify-center py-8">
                      <p className="text-slate-500 text-sm">
                        Enter an amount to see result
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="glass-card p-6 rounded-2xl text-sm">
                  ...
                  <div className="space-y-2 text-slate-300">
                    ...
                    >
                      <span className="text-amber-300 opacity-60">✦</span> Tola
                      to Grams
                    </Link>
                    <Link
                      href="/grams-to-tola"
                      className="flex items-center gap-2 transition-colors hover:text-amber-400"
                    >
                      <span className="text-amber-300 opacity-60">✦</span> Grams
                      to Tola
                    </Link>
                  </div>
                </div>
        ...
        <div className="container-max">
          <div className="glass-card p-6 md:p-10 rounded-2xl">
            <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-6 leading-tight">
              Tola to Masha Converter – Check Weight Instantly
            </h2>
            ...
            <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4">
              ...
              and across South Asia, traditional weight units are still part of
              daily life—especially in gold markets. You'll often hear prices
              and weights in tola and masha, not grams.
            </p>
            <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4">
              That's where confusion begins.
            </p>
            <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4">
              Most people understand grams because they're used globally. But
              when someone says, "This ring is 3 masha" or "Gold rate per tola
              is this," it forces you to switch between systems in your head.
            </p>
            <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4">
            ...
            <p className="text-slate-300 leading-relaxed text-base md:text-lg">
              This uncertainty creates a gap. You might feel unsure about the
              actual value of what you're buying or selling.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Gold is not a small purchase. Even tiny differences in weight can
              change the total price significantly.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Let's say you misunderstand the conversion slightly. That small
              mistake could mean:
            </p>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-6 md:p-8 rounded-2xl border-l-4 border-amber-500 space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                A customer in a local jewelry market wanted to buy gold worth
                1.5 tola. The seller explained the price in masha. The customer
                tried to convert mentally but got unsure.
              </p>
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                Instead of calculating properly, he rounded values and moved
                forward.
              </p>
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                The result?
              ...
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                He ended up agreeing to a price that was slightly higher than
                expected. It didn't look like a big difference at first—but in
                gold pricing, even a small mismatch adds up.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 md:py-12 bg-slate-900">
        <div className="container-max">
          <div className="max-w-4xl mx-auto glass-card p-6 md:p-8 rounded-2xl space-y-5">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Instead of guessing or relying on memory, you can use a simple
              tool that does the work instantly.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="glass-card p-5 rounded-2xl border-l-4 border-amber-500">
                ...
                <p className="text-slate-400 text-sm leading-relaxed mt-3">
                  It has been used for generations and is still standard in many
                  local markets.
                </p>
              </div>
              <div className="glass-card p-5 rounded-2xl border-l-4 border-amber-500">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Masha is a smaller unit within the same system. It allows more
                  precise measurement, especially useful when dealing with small
                  quantities of gold.
                </p>
              </div>
            </div>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              ...
              and neighboring countries. Once you know this, everything becomes
              easier.
            </p>
      ...
      <section className="py-8 md:py-12 bg-slate-900">
        <div className="container-max">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              If you want a complete understanding, it helps to link these units
              with grams.
            </p>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-6 md:p-8 rounded-2xl space-y-5">
              ...
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                To understand how important this is, let's look at a realistic
                scenario.
              </p>
              <h3 className="text-lg font-bold text-amber-400">Situation</h3>
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                A buyer wants to purchase gold weighing 1.25 tola. The seller
                provides the rate per masha.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-800 rounded-xl p-4 space-y-2">
                  ...
                  <p className="text-slate-300 text-sm">
                    If the rate is Rs. 18,500 per masha:
                  </p>
                  <p className="font-mono text-amber-300 text-sm">
                    15 × 18,500 = Rs. 277,500
                  </p>
                </div>
              </div>
              <h3 className="text-lg font-bold text-amber-400">
                What if the buyer didn't convert?
              </h3>
              <div className="space-y-2">
                {[
                  "The buyer might guess",
                  "Or miscalculate",
                  "This could easily lead to paying more than necessary.",
                ].map((point) => (
      ...
      <section className="py-8 md:py-12 bg-slate-900">
        <div className="container-max">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Even experienced people make small errors. Here are a few to watch
              out for:
            </p>
            <div className="space-y-3">
              {[
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {
                  title: "Gold Buyers",
                  desc: "Check weight before making payment.",
                },
                {
                  title: "Jewelry Sellers",
                  desc: "Give accurate information to customers.",
                },
                {
                  title: "Investors",
                  desc: "Track gold holdings with clarity.",
                },
                {
                  title: "Students",
                  desc: "Learn traditional measurement systems easily.",
                },
              ].map(({ title, desc }) => (
      ...
      <section className="py-8 md:py-12 bg-slate-900">
        <div className="container-max">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              In situations where money is involved, accuracy matters more than
              anything.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto glass-card p-6 md:p-8 rounded-2xl space-y-5">
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <span className="text-amber-400 font-black text-lg w-6 text-center">
                    {i + 1}.
                  </span>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-6 md:p-8 rounded-2xl border border-amber-500/30 space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                When both are clear, you can make better decisions without
      ...
      <section className="py-8 md:py-12 bg-slate-900">
        <div className="container-max">
          <div className="max-w-4xl mx-auto glass-card p-6 md:p-8 rounded-2xl space-y-4">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Understanding weight units like tola and masha is not just about
              numbers—it's about making informed decisions.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              When you rely on guesswork, you leave room for mistakes. But when
              you use a proper tool, everything becomes clear.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
            ...
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Whether you're buying gold, selling jewelry, or just learning,
