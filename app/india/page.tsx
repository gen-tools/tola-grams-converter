...
export const metadata: Metadata = {
  ...
  description: 'Convert tola to grams in India and calculate gold value in INR. Instant tola weight conversion and gold price calculator for Indian gold market.',
  keywords: 'tola to grams india, gold tola india, gold rate india inr, tola converter',
  alternates: {
